...
public class ManagementPostApplications_StepDefs extends UtilManager{
    ...
    public void i_am_an_authorized_DRAGON_user_with_role()  {
        ...
        boolean hasRequiredRoles = Optional.ofNullable(testContext.getApiManager().getAccessToken()
                .retrieveClaimSet(getFileHelper().getValueFromPropertiesFile(Hooks.envProperties, "jwks_uri_idp"))
                .getClaim("roles"))
