...
Scenario Outline: Negative flow- Peak error response parsed by DRAGON
  ...
  #And the payment request response should be signed
    Examples:
      ...
      |%%         |HKD     |/return        |Unable to read or parse message body: json parse error at [line: 1, column: 16]                                                                           |Service Request Validation Failed|EA017     |/confirmation     |/unsuccessful  |6                |
