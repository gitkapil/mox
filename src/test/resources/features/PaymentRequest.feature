...
Scenario Outline: Negative flow- Peak error response parsed by DRAGON
  ...
  #And the payment request response should be signed
    Examples:
      ...
      |1000001    |HKD     |/return        |Field error in object 'paymentRequestInputModel': field 'totalAmount' must be less than or equal to 1000000; rejected value [1000001.0]                 |Service Request Validation Failed|EA017     |/confirmation     |/unsuccessful  |20               |
      ...
      |150.00     |HKD     |/return        |Field error in object 'paymentRequestInputModel': field 'effectiveDuration' must be greater than or equal to 15; rejected value [14] |Service Request Validation Failed|EA015     |/confirmation     |/unsuccessful  |14               |
      |150.00     |HKD     |/return        |Field error in object 'paymentRequestInputModel': field 'effectiveDuration' must be less than or equal to 3600; rejected value [3601]|Service Request Validation Failed|EA015     |/confirmation     |/unsuccessful  |3601             |
