...
Feature: DRAG-2123 - Post Payment transaction successful with Integrated POS role
  ...
  @regression @skiponsandbox @paymentsuccess
  Scenario Outline: SC1 - Positive flow- A merchant is able to post a payment successfully with all the valid inputs
    ...
    #  | 1.400       | HKD      | 85288552233 | 147258 |             | http://webhook.site/9b9f7e15-b52a-4004-a249-78c7e740c52f | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD |
     #UAT1
...
#      | 1.200       | HKD      | 85288552233 | 147258 | /return3        | message from merchant | B1242183 | 15                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 400         | QR code expired when scans | Business Rules Incorrect! |
    #UAT1
  ...
  @regression @skiponsandbox @posRefund
...
#      | 1.500       | 1.000        | message from merchant | 00         | HKD      | 85288552233 | 147258 |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD |
...
#      | 1.600       | 1.600        | message from merchant | 00         | HKD      | 85288552233 | 147258 |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD |
      #UAT1
  ...
  @regression @skiponsandbox @skiponversionten
...
#      | 1.300       | 1.500        | message from merchant | 00         | HKD      | 85288552233 | 147258 |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 400        | Refund amount entered > net refundable amount | EB010      |
      #UAT1
...
#      | X-HSBC-Device-Id | 1.200       | 1.200        | message from merchant | 00         | HKD      | 85288552233 | 147258 |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 400        | API gateway validation failed - X-HSBC-Device-Id is mandator | EA002      | Service Request Validation Failed |
    #UAT1
...
#      | X-HSBC-Merchant-Id | 1.100       | 1.100        | message from merchant | 00         | HKD      | 85288552233 | 147258 |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD |
    #UAT1
...
#      | 1.500       | 1.000        | message from merchant | 00         | HKD      | 85288552233 | 147258 | space        |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 400        | API gateway validation failed - X-HSBC-Device-Id is mandatory                         | EA002      | Service Request Validation Failed |
#      | 1.400       | 1.100        | message from merchant | 00         | HKD      | 85288552233 | 147258 | doubleQuotes |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 400        | API gateway validation failed - X-HSBC-Device-Id is mandator                          | EA002      | Service Request Validation Failed |
#      | 1.300       | 1.200        | message from merchant | 00         | HKD      | 85288552233 | 147258 | tooLong      |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 400        | API gateway validation failed - X-HSBC-Device-Id length must be less than equal to 50 | EA002      | Service Request Validation Failed |
    #UAT1
      | 1.500       | 1.000        | message from merchant | 00         | HKD      | 85251493020 | 142434 | space        |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 400        | API gateway validation failed - X-HSBC-Device-Id is mandatory                         | EA002      | Service Request Validation Failed |
      | 1.400       | 1.100        | message from merchant | 00         | HKD      | 85251493020 | 142434 | doubleQuotes |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 400        | API gateway validation failed - X-HSBC-Device-Id is mandator                          | EA002      | Service Request Validation Failed |
      | 1.300       | 1.200        | message from merchant | 00         | HKD      | 85251493020 | 142434 | tooLong      |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 400        | API gateway validation failed - X-HSBC-Device-Id length must be less than equal to 50 | EA002      | Service Request Validation Failed |
...
#      | 1.400       | 1.200        | message from merchant | 00         | HKD      | 85288552233 | 147258 | 3fa85f64-5717-4562-b3fc-2c963f66afa71 |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 401        | Invalid value provided in header X-HSBC-Merchant-Id                                                                                                                                | EA001      | Unauthorized Operation!           |
#      | 1.300       | 1.100        | message from merchant | 00         | HKD      | 85288552233 | 147258 | randomSubUnitId                       |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 400        | Failed to convert value of type 'java.lang.String' to required type 'java.util.UUID'; nested exception is java.lang.IllegalArgumentException: Invalid UUID string: randomSubUnitId | EA002      | Service Request Validation Failed |
#      | 1.200       | 1.000        | message from merchant | 00         | HKD      | 85288552233 | 147258 | 3fa85f64-5717-4562-b3fc-2c963f66afa71 |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 401        | Invalid value provided in header X-HSBC-Merchant-Id                                                                                                                                | EA001      | Unauthorized Operation!           |
    #UAT1
      | 1.400       | 1.200        | message from merchant | 00         | HKD      | 85251493020 | 142434 | 3fa85f64-5717-4562-b3fc-2c963f66afa71 |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 401        | Invalid value provided in header X-HSBC-Merchant-Id                                                                                                                                | EA001      | Unauthorized Operation!           |
      | 1.300       | 1.100        | message from merchant | 00         | HKD      | 85251493020 | 142434 | randomSubUnitId                       |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 400        | Failed to convert value of type 'java.lang.String' to required type 'java.util.UUID'; nested exception is java.lang.IllegalArgumentException: Invalid UUID string: randomSubUnitId | EA002      | Service Request Validation Failed |
      | 1.200       | 1.000        | message from merchant | 00         | HKD      | 85251493020 | 142434 | 3fa85f64-5717-4562-b3fc-2c963f66afa71 |             | /return3        | message from merchant | B1242183 | 60                | /confirmation1     | /unsuccessful9  | pizzapepperoni1234, pepperoni pizza, quantity: 1, price: 60.00, currency: HKD | 401        | Invalid value provided in header X-HSBC-Merchant-Id                                                                                                                                | EA001      | Unauthorized Operation!           |
