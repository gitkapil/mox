...
Scenario Outline: Negative flow - Invalid transaction Id
  ...
  And I enter the refund data with payerId "a", refund amount "2", refund currency "HKD", fee amount "0", fee currency "HKD", reason Code "00" and reason message "test"
...
Examples:
  ...
  |a2d3a25a-3dea-4346-bc49-600e4b83f33e|400        |adf            |EA000   |
