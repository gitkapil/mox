...
Scenario: Positive flow- POST Payment Request digest is a mandatory header field
  ...
  Then I should receive a "400" error response with "Missing request header 'Digest' for method parameter of type String" error description and "EA002" errorcode within payment response
