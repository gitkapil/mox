...
Scenario: Positive flow- POST Payment Request digest is a mandatory header field
  ...
  Then I should receive a quoted "401" error response with 'Unable to verify signature: Missing required signature header "digest"' error description and "EA001" errorcode within payment response
  And error message should be "Unauthorized Operation!" within payment response
