...
Feature: Management Put Applications API - DRAG-1446
  ...
  Scenario Outline: Positive flow- Put application and verify the application info using get application
    ...
    Examples:
      | description | platform | clientId                             | peakId                               | subUnitId                            | organisationId                       | filterName | filterValue                          | numberOfResponses |
      | description | platform | 00000001-0000-0000-0000-000000000000 | 00000002-0000-0000-c000-000000000001 | eafb2a7b-297d-444e-b473-2e724e864806 | a96cd9ba-a1f6-4d9a-b146-8118fa8fbed1 | clientId   | 00000001-0000-0000-0000-000000000000 | 1                 |
...
#   @trial
  ...
  Scenario Outline: Negative flow- Mandatory fields from the body missing or invalid
    ...
    And error message should be "<error_message>" within the PUT application response
    Examples:
      | applicationId                       | missBodyValue  | clientId                             | peakId                               | subUnitId                            | organisationId                       | error_description                                                                                                                  | error_message                     | error_code |
